...
public class FPA 
{
	...
	private double F0 = 0.637*T - AF0;//0.6183*T - AF0;//
	private double P0 = 0.363*T - AP0;//0.3817*T - AF0;//
	...
	private void runSimulation()
	{
		for (int t=0; t<tspan-1; t++)
		{
			...
			F[t+1] = F[t] - alpha*Rplus*Theta(Rplus) + beta*BF[t];
			P[t+1] = P[t] - (1-alpha)*Rplus*Theta(Rplus) + delta*BP[t];
			...
			BP[t+1] = BP[t] + (1-gamma)*Rminus*Theta(Rminus) - delta*BF[t] + epsilon*AP[t];
		}
	}
